...
When running on raspberry pi you need the arm version of hadoop (aarch64)
Additionally you need to install libssl for arm, an older version. It can be found here
http://ports.ubuntu.com/pool/main/o/openssl/
